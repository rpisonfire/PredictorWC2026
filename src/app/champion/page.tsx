    ...
    <section className="max-w-2xl mx-auto">
      ...
      {currentTeam && (
        <div className="card p-4 mb-5 border-wc-gold/40">
          <div className="text-xs uppercase tracking-wider text-white/40">Twój aktualny typ</div>
      ...
      {lock.locked ? (
        <div className="card p-6 text-center border-white/10">
            ...
            {teams.map((t) => {
              ...
              return (
                <label key={t.id} className="cursor-pointer">
                  ...
                  <span className={`flex items-center gap-2 p-3 rounded-xl border border-white/10 peer-checked:border-wc-gold peer-checked:bg-wc-gold/10 hover:bg-white/5 ${active ? "ring-1 ring-wc-gold/30" : ""}`}>
